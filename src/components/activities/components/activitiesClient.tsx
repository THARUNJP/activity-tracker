...
export default function ActivitiesClient({
  ...
  async function addActivity(e: FormEvent<HTMLFormElement>) {
    ...
    // Ensure valid value (prevents "always leisure" issue)
    const safeProductivity: ProductivityType =
      productivity === "productive" || productivity === "leisure"
        ? productivity
        : "productive";
    ...
    <div className="animate-fade-in max-w-[820px] w-full mx-auto px-4 py-4">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-semibold rounded-lg bg-[var(--accent)] text-white hover:opacity-90 active:scale-[0.98] transition-all duration-150"
        >
          <span
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (value === "productive" || value === "leisure") {
              ...
              <div className="flex flex-wrap gap-2">
                {ICONS.map((i) => (
                  <button
                    ...
                    type="button"
                    onClick={() => setIcon(i)}
                    className={`w-9 h-9 rounded-md text-lg flex items-center justify-center border transition-all duration-150 ${
                      icon === i
